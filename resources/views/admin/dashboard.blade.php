...
@section('title', 'Controle Escolar | Painel de Controle')
        ...
        <div class="content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="card-footer ">
                    ...
                    <div class="stats">
                    <i class="fa fa-refresh"></i>
                    Funcionários nesta instituição
                    </div>
                </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="card-footer ">
                    ...
                    <div class="stats">
                    <i class="fa fa-refresh"></i>
                    Recursos humanos nesta instituição
                    </div>
                </div>
                </div>
            </div>
